...
import com.github.mvidecomposeweatherapp.domain.usecase.SearchCityUseCase
import com.github.mvidecomposeweatherapp.presentation.search.OpenReason.*
import com.github.mvidecomposeweatherapp.presentation.search.SearchStore.Intent
import com.github.mvidecomposeweatherapp.presentation.search.SearchStore.Label
import com.github.mvidecomposeweatherapp.presentation.search.SearchStore.State
...
class SearchStoreFactory @Inject constructor(
    ...
    private class BootstrapperImpl : CoroutineBootstrapper<Action>() {
        override fun invoke() {} // пустой, тк нет начальной загрузки данных
    }
