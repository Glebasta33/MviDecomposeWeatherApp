...
import com.github.mvidecomposeweatherapp.domain.usecase.GetCurrentWeatherUseCase
import com.github.mvidecomposeweatherapp.domain.usecase.GetFavouriteCitiesUseCase
import com.github.mvidecomposeweatherapp.presentation.favourite.FavouriteStore.Intent
import com.github.mvidecomposeweatherapp.presentation.favourite.FavouriteStore.Label
import com.github.mvidecomposeweatherapp.presentation.favourite.FavouriteStore.State
...
interface FavouriteStore : Store<Intent, State, Label> {
    ...
    sealed interface Label {
        ...
        data object OnClickToFavourite : Label
        data class OnCityItemClicked(val city: City) : Label
    }
}
        ...
        override fun executeIntent(intent: Intent, getState: () -> State) {
            when (intent) {
                is Intent.CityItemClicked -> {
                    publish(Label.OnCityItemClicked(intent.city))
                }

                Intent.ClickSearch -> {
                    publish(Label.OnClickSearch)
                }

                Intent.ClickToFavourite -> {
                    publish(Label.OnClickToFavourite)
                }
            }
        }
